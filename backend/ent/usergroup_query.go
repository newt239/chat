...
func (_q *UserGroupQuery) QueryWorkspace() *WorkspaceQuery {
...
func (_q *UserGroupQuery) QueryCreatedBy() *UserQuery {
...
func (_q *UserGroupQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserGroupQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserGroupQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserGroupQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserGroupQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *UserGroupQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserGroupQuery) WithWorkspace(opts ...func(*WorkspaceQuery)) *UserGroupQuery {
	query := (&WorkspaceClient{config: _q.config}).Query()
...
func (_q *UserGroupQuery) WithCreatedBy(opts ...func(*UserQuery)) *UserGroupQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserGroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserGroup, error) {
	...
	if query := _q.withWorkspace; query != nil {
		if err := _q.loadWorkspace(ctx, query, nodes, nil,
			func(n *UserGroup, e *Workspace) { n.Edges.Workspace = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserGroupQuery) loadCreatedBy(ctx context.Context, query *UserQuery, nodes []*UserGroup, init func(*UserGroup), assign func(*UserGroup, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*UserGroup)
	for i := range nodes {
