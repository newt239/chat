...
func (_c *ThreadReadStateCreate) SetNillableLastReadAt(v *time.Time) *ThreadReadStateCreate {
	if v != nil {
		_c.SetLastReadAt(*v)
	}
	return _c
...
func (_c *ThreadReadStateCreate) SetNillableID(v *uuid.UUID) *ThreadReadStateCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ThreadReadStateCreate) SetThread(v *Message) *ThreadReadStateCreate {
...
func (_c *ThreadReadStateCreate) check() error {
	...
	if len(_c.mutation.ThreadIDs()) == 0 {
		return &ValidationError{Name: "thread", err: errors.New(`ent: missing required edge "ThreadReadState.thread"`)}
	}
	return nil
}
...
func (_c *ThreadReadStateCreate) createSpec() (*ThreadReadState, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(threadreadstate.Table, sqlgraph.NewFieldSpec(threadreadstate.FieldID, field.TypeUUID))
	)
