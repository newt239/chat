...
func (_c *MessagePinCreate) SetNillableCreatedAt(v *time.Time) *MessagePinCreate {
	if v != nil {
		_c.SetCreatedAt(*v)
	}
	return _c
...
func (_c *MessagePinCreate) SetPinnedBy(v *User) *MessagePinCreate {
	return _c.SetPinnedByID(v.ID)
}
...
func (_c *MessagePinCreate) check() error {
	...
	if len(_c.mutation.ChannelIDs()) == 0 {
		return &ValidationError{Name: "channel", err: errors.New(`ent: missing required edge "MessagePin.channel"`)}
	}
	if len(_c.mutation.MessageIDs()) == 0 {
		return &ValidationError{Name: "message", err: errors.New(`ent: missing required edge "MessagePin.message"`)}
	}
	if len(_c.mutation.PinnedByIDs()) == 0 {
		return &ValidationError{Name: "pinned_by", err: errors.New(`ent: missing required edge "MessagePin.pinned_by"`)}
	}
	return nil
}
...
func (_c *MessagePinCreate) createSpec() (*MessagePin, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CreatedAt(); ok {
		_spec.SetField(messagepin.FieldCreatedAt, field.TypeTime, value)
